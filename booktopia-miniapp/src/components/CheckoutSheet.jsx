...
const T = {
  ...
  address:      { uz: 'Manzilingiz *',        ru: 'Ваш адрес *',        en: 'Your address *' },
  addressHint:  { uz: 'Viloyat va shahringizni yozsangiz yetarli — qolganini qo\'ng\'iroqda aniqlashtiramiz.',
                  ru: 'Достаточно области и города — остальное уточним по телефону.',
                  en: 'Region and city are enough — we confirm the rest by phone.' },
  gpsBtn:       { uz: 'Joylashuvni yuborish', ru: 'Отправить геолокацию', en: 'Share location' },
  gpsAttached:  { uz: 'Joylashuv biriktirildi — eng yaqin pochta bo\'limini aniqlashga yordam beradi',
  ...
  gpsDone:      { uz: 'Joylashuv qo\'shildi', ru: 'Геолокация добавлена', en: 'Location added' },
  addressPh:    { uz: 'Masalan: Farg\'ona viloyati, Farg\'ona shahri',
                  ru: 'Например: Ферганская область, г. Фергана',
                  en: 'e.g. Fergana region, Fergana city' },
