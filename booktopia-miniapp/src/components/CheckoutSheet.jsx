...
const T = {
  ...
  addressHint:  { uz: 'Viloyat, tuman va pochta bo\'limingizni yozing — kitobni o\'sha bo\'limdan olasiz.',
  ...
  addressPh:    { uz: 'Masalan: Farg\'ona sh., 12-pochta bo\'limi', ru: 'Например: г. Фергана, отделение №12', en: 'e.g. Fergana, post office 12' },
